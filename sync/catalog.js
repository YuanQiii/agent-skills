...
const { config, log, readAllSkills } = require('./utils');
const { loadTranslations } = require('./translator');
...
module.exports = { generateCatalog, classifySkill, CATEGORIES, CATEGORY_ORDER };
